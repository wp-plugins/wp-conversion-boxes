    ...
    <table class="form-table">
            <tbody>
                    <tr>
                            <th scope="row">
                                <label for="">
                                    Select a List/Campaign
                                </label>
                            </th>
                            <td>
                                <?php $this->get_mailer_campaigns_list($wpcb_default_fields['input_campaign_name']); ?>
                                <p class="wpcb_help_block">Select a campaign/list to which you want to add the leads generated by this box.</p>
                            </td>
                    </tr>
                    <tr class="opaque6">
                            <th scope="row">
                                <label for="">
                                    After Optin Redirect To
                                    <?= $wpcb_upgrade_message; ?>
                                </label>
                            </th>
                            <td>
                                <label><input placeholder="http://" type="text" name="input_redirect_url" id="input_redirect_url" value="" class="wpcb_fullwidth" disabled /></label>
                                <p class="wpcb_help_block">Enter a link where you want to redirect users after successful optin. Leave empty if you want users to stay on same page.</p>
                            </td>
                    </tr>
                    <tr>
                            <th scope="row">
                            ...
                            <td>
                                <label><input type="text" name="input_text_size" id="input_text_size" value="<?= $wpcb_default_fields['input_text_size'] ?>" class="wpcb_width50px"> (in px)</label>
                            </td>
                    </tr>
                    <tr>
                            <th scope="row"><label for="">
                            ...
                            <td>
                                    <input type="text" name="input_text_color" id="input_text_color" value="<?= $wpcb_default_fields['input_text_color'] ?>" data-default-color="<?= $wpcb_default_fields['input_text_color'] ?>">
                            </td>
                    </tr>       
                    <tr>
                            <th scope="row"><label for="">
                    ...
                    <tr>
                            ...
                            <td>
                                    <input type="text" name="input_name_placeholder" id="input_name_placeholder" value="<?= $wpcb_default_fields['input_name_placeholder'] ?>" class="wpcb_fullwidth">
                            </td>
                    </tr>                    
                    <tr>
                            <th scope="row"><label for="">
                            ...
                            <td>
                                    <input type="text" name="input_email_placeholder" id="input_email_placeholder" value="<?= $wpcb_default_fields['input_email_placeholder'] ?>" class="wpcb_fullwidth">
                            </td>
                    </tr> 
                    <tr>
                            <th scope="row"><label for="">
                            ...
                            <td>
                                    <label><input type="text" name="input_width" id="input_width" value="<?= $wpcb_default_fields['input_width'] ?>" class="wpcb_width50px"> (in px or %)</label>
                            </td>
                    </tr>
