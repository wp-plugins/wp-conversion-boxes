...
?>
    ...
    <div class='wpcb_box_type'>
        ...
        <input type="radio" class="wpcb_box_type_radio" id="wpcb_box_5" name="wpcb_box_type" value="5" <?php if($box_type == '5') echo "checked"; ?>>
           <label for="wpcb_box_5" id="wpcb_box_5_label"><?php _e('2-Step Optin Link (New)','wp-conversion-boxes'); ?></label>    
    </div>
    ...
    <div class="wpcb_box_div wpcb_box_type_5">
        <div class="postbox">
            <h3><?php _e('2-Step Optin Link (New)','wp-conversion-boxes'); ?> <i class="fa fa-question-circle" id="two-step-toggle"></i></h3>
