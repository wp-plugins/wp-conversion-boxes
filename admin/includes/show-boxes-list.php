    ...
    if($result_count != 0){
        ...
        <table class="wp-list-table widefat fixed posts" style="clear: none;">
            ...
            foreach ($results as $result){
                ...
                $conversion_type = ($box_type == 1 || $box_type == 2) ? "<span class='wpcb_conversion_type'>". __('Optins','wp-conversion-boxes') . "</span>" : "<span class='wpcb_conversion_type'>". __('Clicks','wp-conversion-boxes') . "</span>";
