...
if($wpcb_default_fields == '' or $wpcb_default_fields['defaults'] == 'defaults'){
    $wpcb_default_fields = array(
            ...
            'heading_text'  => 'Subscribe To Our Newsletter',
            'heading_font_familiy'  => 'Courier New',
            ...
            'content_text' => 'We Respect Your Privacy.',
            'content_font_familiy'  => 'Arial',
            'content_font_size' => '14px',
            'content_line_height' => '22px',
            'content_color' => '#999',
            ...
            'image_url' => plugins_url( 'imgs/stamp.jpg' , __FILE__ ),
            'image_width' => '100px',
            'image_height' => '',
            'image_align' => 'right',
...
<style>
    ...
    .wpcb_template_main_<?php echo $box_id; ?>{
        ...
        background-image: url('<?php echo plugins_url( 'imgs/mail.png' , __FILE__ ); ?>');
        padding: 10px;
        border-radius: 5px;
    }
    
    .wpcb_template_main_<?php echo $box_id; ?> .wpcb_box_all_content_container{
